		...
		<table class="booking-customer-details">
			<?php
				...
				if ( $booking->get_order_id() && ( $order = wc_get_order( $booking->get_order_id() ) ) ) {
					...
					<tr>
						<th><?php esc_html_e( 'Vehicle Year:', 'woocommerce-bookings' ); ?></th>
						<td><?php echo esc_html( $user->account_car_year  ? $user->account_car_year : '&mdash;' ); ?></td>
					</tr>
					<tr>
						<th><?php esc_html_e( 'Vehicle Make:', 'woocommerce-bookings' ); ?></th>
						<td><?php echo esc_html( $user->account_car_make ? $user->account_car_make : '&mdash;' ); ?></td>
					</tr>
					<tr>
						<th><?php esc_html_e( 'Vehicle Model:', 'woocommerce-bookings' ); ?></th>
						<td><?php echo esc_html( $user->account_car_model ? $user->account_car_model : '&mdash;' ); ?></td>
					</tr>
					<tr>
